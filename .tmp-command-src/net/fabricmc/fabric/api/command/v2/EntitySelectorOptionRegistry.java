...
public final class EntitySelectorOptionRegistry {
	 ...
	 */
	public static void register(class_2960 id, class_2561 description, class_2306.class_2307 handler, Predicate<class_2303> canUse) {
		EntitySelectorOptionsAccessor.callPutOption(id.method_36181(), handler, canUse, description);
	}
	 ...
	 * @param handler the handler for the entity option that reads and sets the predicate
	 */
	public static void registerNonRepeatable(class_2960 id, class_2561 description, class_2306.class_2307 handler) {
