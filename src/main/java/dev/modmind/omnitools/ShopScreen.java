...
/** Client presentation for the six-row shop chest. */
public final class ShopScreen extends AbstractContainerScreen<ShopScreenHandler> {
    ...
    public ShopScreen(ShopScreenHandler menu, Inventory inventory, Component title) {
        super(menu, inventory, title);
        this.imageHeight = 114 + ShopScreenHandler.ROWS * 18;
    ...
    protected void renderBg(GuiGraphics graphics, float delta, int mouseX, int mouseY) {
        ...
        graphics.blit(pipeline, CONTAINER_BACKGROUND, left, top, 0.0F, 0.0F,
                imageWidth, ShopScreenHandler.ROWS * 18 + 17, 256, 256);
        graphics.blit(pipeline, CONTAINER_BACKGROUND, left, top + ShopScreenHandler.ROWS * 18 + 17,
