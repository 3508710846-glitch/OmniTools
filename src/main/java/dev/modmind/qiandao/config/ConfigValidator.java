...
public final class ConfigValidator {
    ...
    public static void validate(QiandaoConfigSnapshot snapshot) {
        if (snapshot.root() == null || snapshot.rewards() == null || snapshot.shop() == null
            ...
            throw new IllegalArgumentException("qiandao configuration snapshot is incomplete");
        }
    ...
    private static boolean isAllowedPermission(String value) {
        ...
        return permission.equals("qiandao:cloud_storage") || permission.startsWith("qiandao:command.");
    }
}
