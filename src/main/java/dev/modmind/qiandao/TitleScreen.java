...
/** Client presentation for the title selection chest menu. */
public final class TitleScreen extends AbstractContainerScreen<TitleScreenHandler> {
    ...
    public TitleScreen(TitleScreenHandler menu, Inventory inventory, Component title) {
        super(menu, inventory, title);
        this.imageHeight = 114 + TitleScreenHandler.ROWS * 18;
    ...
    protected void renderBg(GuiGraphics graphics, float delta, int mouseX, int mouseY) {
        ...
        graphics.blit(pipeline, CONTAINER_BACKGROUND, left, top, 0.0F, 0.0F,
                imageWidth, TitleScreenHandler.ROWS * 18 + 17, 256, 256);
        graphics.blit(pipeline, CONTAINER_BACKGROUND, left, top + TitleScreenHandler.ROWS * 18 + 17,
